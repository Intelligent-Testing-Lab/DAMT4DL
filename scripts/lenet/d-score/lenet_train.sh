...
#SBATCH --output=./Output/lenet/d-score/train/${mutation}_%j.out
#SBATCH --error=./Output/lenet/d-score/train/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=le_d_tr_${mutation}
...
python ./cmd/main.py --config ./config_file/lenet/d-score/train/${mutation}.yaml --properties ./properties/lenet/properties.py --constants ./properties/lenet/constants.py
"
