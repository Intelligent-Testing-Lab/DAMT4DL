...
python ./cmd/main.py --config ./config_file/lenet/k-score/test/${mutation}.yaml --properties ./properties/lenet/properties.py --constants ./properties/lenet/constants.py
"
