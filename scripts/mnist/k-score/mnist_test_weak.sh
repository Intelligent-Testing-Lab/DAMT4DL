...
#SBATCH --output=./Output/mnist/k-score/test_weak/${mutation}_%j.out
#SBATCH --error=./Output/mnist/k-score/test_weak/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=mn_k_tw_${mutation}
...
python ./cmd/main.py --config ./config_file/mnist/k-score/test_weak/${mutation}.yaml --properties ./properties/mnist/properties.py --constants ./properties/mnist/constants.py
"
