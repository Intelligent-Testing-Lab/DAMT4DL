...
#SBATCH --output=./Output/mnist/test/k-score/one_GPU.out
#SBATCH --error=./Output/mnist/test/k-score/one_GPU.err  # Standard error log
#SBATCH --tasks-per-node=1  # Specify the number of tasks on each node
#SBATCH --job-name=mn_te_1
...
python ./cmd/main.py --config ./config_file/mnist/k-score/mnist_test_one.yaml --properties ./properties/mnist/properties.py --constants ./properties/mnist/constants.py
