...
#SBATCH --output=./Output/mnist/k-score/train/${mutation}_%j.out
#SBATCH --error=./Output/mnist/k-score/train/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=mn_k_tr_${mutation}
...
python ./cmd/main.py --config ./config_file/mnist/k-score/train/${mutation}.yaml --properties ./properties/mnist/properties.py --constants ./properties/mnist/constants.py
"
