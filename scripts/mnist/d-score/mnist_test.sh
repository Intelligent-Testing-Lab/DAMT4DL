...
#SBATCH --output=./Output/mnist/d-score/test/${mutation}_%j.out
#SBATCH --error=./Output/mnist/d-score/test/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=mn_d_te_${mutation}
...
python ./cmd/main.py --config ./config_file/mnist/d-score/test/${mutation}.yaml --properties ./properties/mnist/properties.py --constants ./properties/mnist/constants.py
"
