...
#SBATCH --output=./Output/mnist/d-score/test_weak/${mutation}_%j.out
#SBATCH --error=./Output/mnist/d-score/test_weak/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=mn_d_tw_${mutation}
...
python ./cmd/main.py --config ./config_file/mnist/d-score/test_weak/${mutation}.yaml --properties ./properties/mnist/properties.py --constants ./properties/mnist/constants.py
"
