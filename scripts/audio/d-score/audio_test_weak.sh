...
#SBATCH --output=./Output/audio/d-score/test_weak/${mutation}_%j.out
#SBATCH --error=./Output/audio/d-score/test_weak/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=au_d_tw_${mutation}
...
python ./cmd/main.py --config ./config_file/audio/d-score/test_weak/${mutation}.yaml --properties ./properties/audio/properties.py --constants ./properties/audio/constants.py
"
