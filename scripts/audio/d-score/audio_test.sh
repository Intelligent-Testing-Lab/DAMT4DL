...
#SBATCH --output=./Output/audio/d-score/test/${mutation}_%j.out
#SBATCH --error=./Output/audio/d-score/test/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=au_d_te_${mutation}
...
python ./cmd/main.py --config ./config_file/audio/d-score/test/${mutation}.yaml --properties ./properties/audio/properties.py --constants ./properties/audio/constants.py
"
