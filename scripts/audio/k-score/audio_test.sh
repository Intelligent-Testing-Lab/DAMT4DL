...
mutations=("change_label", "delete_training_data", "unbalance_train_data", "make_output_classes_overlap",
                      ...
                      "change_optimisation_function", "remove_validation_set", "change_earlystopping_patience")
...
#SBATCH --output=./Output/audio/k-score/test/${mutation}_%j.out
...
python ./cmd/main.py --config ./config_file/audio/k-score/test/${mutation}.yaml --properties ./properties/audio/properties.py --constants ./properties/audio/constants.py
"
