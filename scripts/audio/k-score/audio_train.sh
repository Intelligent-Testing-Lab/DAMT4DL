...
#SBATCH --output=./Output/audio/k-score/train/${mutation}_%j.out
#SBATCH --error=./Output/audio/k-score/train/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=au_k_tr_${mutation}
...
python ./cmd/main.py --config ./config_file/audio/k-score/train/${mutation}.yaml --properties ./properties/audio/properties.py --constants ./properties/audio/constants.py
"
