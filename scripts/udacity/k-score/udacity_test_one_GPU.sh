...
#SBATCH --output=./Output/udacity/test/one_GPU.out
#SBATCH --error=./Output/udacity/test/one_GPU.err  # Standard error log
...
python ./cmd/main.py --config ./config_file/udacity/k-score/udacity_test_one.yaml --properties ./properties/udacity/properties.py --constants ./properties/udacity/constants.py