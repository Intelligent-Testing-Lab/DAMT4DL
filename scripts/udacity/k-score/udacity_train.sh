...
#SBATCH --output=./Output/udacity/k-score/train/${mutation}_%j.out
#SBATCH --error=./Output/udacity/k-score/train/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=ud_k_tr_${mutation}
...
python ./cmd/main.py --config ./config_file/udacity/k-score/train/${mutation}.yaml --properties ./properties/udacity/properties.py --constants ./properties/udacity/constants.py
"
