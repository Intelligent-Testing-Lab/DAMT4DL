...
#SBATCH --output=./Output/udacity/d-score/test/${mutation}_%j.out
#SBATCH --error=./Output/udacity/d-score/test/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=ud_d_te_${mutation}
...
python ./cmd/main.py --config ./config_file/udacity/d-score/test/${mutation}.yaml --properties ./properties/udacity/properties.py --constants ./properties/udacity/constants.py
"
