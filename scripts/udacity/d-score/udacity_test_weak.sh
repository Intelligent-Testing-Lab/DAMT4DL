...
#SBATCH --output=./Output/udacity/d-score/test_weak/${mutation}_%j.out
#SBATCH --error=./Output/udacity/d-score/test_weak/${mutation}_%j.err  # Standard error log
#SBATCH --job-name=ud_d_tw_${mutation}
...
python ./cmd/main.py --config ./config_file/udacity/d-score/test_weak/${mutation}.yaml --properties ./properties/udacity/properties.py --constants ./properties/udacity/constants.py
"
